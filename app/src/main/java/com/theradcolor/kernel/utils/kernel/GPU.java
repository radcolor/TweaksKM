...
public class GPU {
    ...
    private static GPU sIOInstance;
    ...
    private static final String KGSL3D0_DEVFREQ_GPUBUSY_PER = "/sys/class/kgsl/kgsl-3d0/gpu_busy_percentage";
    ...
    public static String getBusyPer() {
