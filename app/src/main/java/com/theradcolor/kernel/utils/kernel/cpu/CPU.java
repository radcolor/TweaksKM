...
import com.theradcolor.kernel.utils.kernel.cpu.MSMPerformance;
import com.theradcolor.kernel.utils.kernel.cpuhotplug.CoreCtl;
import com.theradcolor.kernel.utils.kernel.cpuhotplug.MPDecision;
import com.theradcolor.kernel.utils.kernel.cpuhotplug.QcomBcl;
...
public class CPU {
    ...
    private static CPU sInstance;

    public static CPU getInstance() {
        return getInstance(null);
    }

    public static CPU getInstance(Context context) {
        if (sInstance == null) {
            sInstance = new CPU();
        }
        return sInstance;
    ...
    public void onlineCpu(int cpu, boolean online, boolean onlineSys, Context context) {
        onlineCpu(cpu, online, "CPU", onlineSys, context);
    }
    ...
    private void run(String command, String id, Context context) {
        Control.runSetting(command, "CPU", id, context);
    }
